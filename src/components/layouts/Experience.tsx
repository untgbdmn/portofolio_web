    ...
    <div className='w-full h-full'>
      <div className="flex flex-row-reverse items-center justify-center gap-3">
        <div className="flex flex-col h-full w-full text-center lg:text-start">
            <h1 className="text-dark text-xl font-bold dark:text-light">PT Belanja Pasti Indonesia</h1>
            <p className="text-sm font-normal italic">2024 - present</p>
            <p className="text-sm font-semibold dark:text-secondary">Web Developer</p>
        </div>
