    ...
    <div className='w-full h-full'>
      <div className="flex flex-row-reverse items-center justify-center gap-3">
        <div className="flex flex-col h-full w-full text-center lg:text-start">
            <h1 data-aos="fade-right" className="text-dark text-xl font-bold dark:text-light">SMK Negeri 2 Pengasih</h1>
            <p data-aos="fade-right" className="text-sm font-normal italic">2021 - 2024</p>
            <p data-aos="fade-right" className="text-sm font-semibold dark:text-secondary">Teknik Jaringan Komputer dan Telekomunikasi</p>
        </div>
