...
export default function Skills() {
  ...
  return (
    <div id='skills' className='px-4 w-[90%] mx-auto'>
        <div data-aos="fade-down" className="flex flex-row-reverse items-center justify-center">
            <HyperText
        ...
        <div className="flex lg:flex-row flex-col-reverse w-full h-full gap-y-5">
            <div className="w-full lg:w-[70%] h-full">
                ...
                <div className="h-full w-full mt-8 px-4 py-3">
                    <SkillsIcon />
                </div>
            </div>
            <div data-aos="fade-down" className="w-full lg:w-[30%] h-full">
