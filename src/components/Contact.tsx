...
export default function Contact() {
  ...
  return (
    <div id='contact' className='px-4 w-[90%] mx-auto pb-2'>
        <div data-aos="fade-up" className="flex flex-row-reverse items-center justify-center">
            <HyperText data-aos="fade-up"
            className="text-xl font-bold text-black dark:text-white lg:mr-2 mr-0"
            text="contact"
            />
            <div data-aos="fade-up" className="h-[2px] lg:w-[90%] w-[78%] bg-black dark:bg-white mr-5"></div>
        </div>

        <div className='flex lg:flex-row flex-col gap-4 lg:gap-0'>
            <div className="text-center lg:text-start">
                <h1 data-aos="fade-down" className="text-2xl font-sans font-bold">Get in Touch!</h1>
                <div className="">
                    <div data-aos="fade-down" className="flex flex-col text-lg font-bold">
                        <h1 className="">Untung Budiman</h1>
                        <h2 className="text-sm text-primary">Web Developer</h2>
                        <div data-aos="fade-down" className="flex flex-col text-sm mt-2 text-center lg:text-start justify-center lg:justify-start items-center lg:items-start">
                        ...
                        <div data-aos="fade-down" className="flex flex-row gap-2 mt-2 items-center lg:items-start justify-center lg:justify-start">
            ...
            <form action="" className="w-full lg:ml-10 ml-0 flex-row flex gap-4">
                <div data-aos="fade-down" className="flex flex-col w-1/2 h-full gap-3">
                ...
                <div data-aos="fade-down" className="flex flex-col w-1/2">
